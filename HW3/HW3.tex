...
\\ Answer:\\
Table 2 Column (2) shows the reduced form estimates when adding $nearc2$ and $nearc4$ together. The coefficient for $nearc2$ is 0.123 with standard error of 0.077 which is not statistically significant. Compared to previous result, the coefficient for $nearc4$ is now 
