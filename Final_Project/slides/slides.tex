...
\setbeamercovered{transparent}
    \begin{block}{Findings 1}
        Panel OLS preliminary result indicates that only the fuel program significantly affected transportation costs in rural areas. \hyperlink{POLS}{\beamergotobutton{Panel OLS}}\label{POLSclick}
    \end{block}
...
\subsection{POLS Preliminary Result}
\begin{frame}
\label{POLS}
    \begin{table}[h]
