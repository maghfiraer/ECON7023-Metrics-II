...
\setbeamercovered{transparent}
    \begin{block}{Findings 1}
        Panel OLS result indicates that both programs have affected transportation costs in rural areas. \hyperlink{POLS}{\beamergotobutton{Panel OLS}}\label{POLSclick}
    \end{block}
...
\label{POLS}
    ...
    \scalebox{0.55}{\input{Final_Project/output/table/POLS}}    
    \end{table}
\end{frame}
