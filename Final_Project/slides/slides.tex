...
\setbeamercovered{transparent}
    ...
    \pause\begin{block}{Findings 3}
        I enrich the analysis by generating an interaction variable between programs to explore the complementary effect of both programs. The interaction term is statistically insignificant. \hyperlink{POLS1}{\beamergotobutton{Panel OLS 2}}
    \end{block}
...
\label{POLS1}
    \begin{table}[h]
    \caption{POLS Result with interaction terms \hyperlink{POLSclick}{\beamerreturnbutton{Back}}}
