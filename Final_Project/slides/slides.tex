...
\begin{itemize}
    ...
    \item Following \citet{abadie2016}, I can use \al{Propensity Score Matching} to construct an artificial control group by matching each treated unit with a non-treated unit of similar characteristics (\texit{to do})
...
\setbeamercovered{transparent}
    ...
    \begin{block}{Findings 3}
        I enrich the analysis by generating an interaction variable between programs to explore the complementary effect of both programs. \hyperlink{POLS2}{\beamergotobutton{Panel OLS 2}}
    \end{block}
\end{frame}
