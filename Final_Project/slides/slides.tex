...
\setbeamercovered{transparent}
    ...
    \begin{block}{Findings 3}
        I enrich the analysis by generating an interaction variable between programs to explore the complementary effect of both programs. The interaction term is statistically insignificant. \hyperlink{POLS1}{\beamergotobutton{Panel OLS 2}}\label{BacktoPOLS}
    \end{block}
\end{frame}
...
\begin{frame}
   \begin{itemize}
       \item The cost-benefit analysis could be performed to estimate the efficiency of the programs considering we already identify the effect of both programs.
   \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        ...
        \item Further cost-benefit analysis on a marginal change of unit transportation per amount of budget spent could \al{substantially inform policy-makers}.
