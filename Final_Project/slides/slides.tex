...
\begin{itemize}
    ...
    \item \al{Endogeneity} treat from Village Fund Transfer $(VF_{it})$ and Treatment $(D_{it})$, therefore I need to identify whether there is a good instrument available in the datasets. \hyperlink{FSVF}{\beamergotobutton{$VF_{it}$}}\label{VFclick}\hyperlink{FSD}{\beamergotobutton{$D_{it}$}}\label{Dclick}
    \item 
...
\label{FSVF}
    ...
    \scalebox{0.6}{\input{Final_Project/output/table/firststage}}    
    \end{table}
\end{frame}
...
\label{hausmanspec}
    \begin{table}[h]
    \caption{First Stage Regression on Village Fund Transfer \hyperlink{hausmanclick}{\beamerreturnbutton{Back}}}
    \scalebox{0.55}{\input{Final_Project/output/table/firststage}}    
    \end{table}
