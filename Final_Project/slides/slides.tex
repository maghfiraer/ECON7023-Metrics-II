...
\begin{itemize}
    ...
    \item \al{Endogeneity} treat from Village Fund Transfer $(VF_{it})$ and Treatment $(D_{it})$
...
\begin{frame}
    ...
    \resizebox{.4\textwidth}{!}{%
        y_{it}=\alpha_i+\delta_1 D_{it}+\gamma_1 VF_{it}+\textbf{X}\pmb{\beta}+\varepsilon_{it}
    }%
    \end{equation*}
\end{frame}
