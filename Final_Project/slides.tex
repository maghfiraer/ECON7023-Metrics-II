...
\begin{itemize}
    \item Developing countries have been focusing on decentralization and local government reform with the believe that they are more efficient in bringing local development (\cite{vazquez_2017}) 
    \item 
    \item 
\end{itemize}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        ...
        \item I obtained the Village Potential Statistics data for the year 2011, 2014 and 2018 from Indonesia's Central Bureau of Statistics consisting of .
