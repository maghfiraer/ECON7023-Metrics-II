...
\thanks{Maghfira Ramadhani: Georgia Institute of Technology. Acknowledgments.}}
\date{March 2023}                       
...
In this section, I discussed the conceptual framework for understanding the impact of ... on rural accessibility.
...
\subsection{Transportation structure}
...
\begin{figure}[p]
\subcaptionbox{Caption for panel a}{\includegraphics[scale=\sfig,page=1]{\pdf}}\hfill
\subcaptionbox{Caption for panel b}{\includegraphics[scale=\sfig,page=2]{\pdf}}\vfig
