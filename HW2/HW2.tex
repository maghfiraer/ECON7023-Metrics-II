...
\end{align*}
From the $F$-test, the $P$-value is $0.015$, which indicates a significant level of 1.5\%. Thus we can reject the null hypothesis, and conclude with some certainty that $educ(IQ-100)$ and $educ(KWW-\overline{KWW})$ are jointly significant.\input{HW2/411d.tex}\\
